<?php
include("includes/campaigns-import.php");
?>
<!DOCTYPE html>
<html lang="fr">
<head>
            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">
                        <i class="fas fa-file-import text-primary"></i> Import de Campagnes
                    </h1>
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    <strong>Format requis :</strong> Colonnes acceptées : name, subject, type, status, scheduled_at, sender_name, sender_email, audience, recipients_emails
                                </div>
                                ...
                                <form id="import-form" enctype="multipart/form-data" method="post" action="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="default_type" class="form-label">Type par défaut</label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="default_status" class="form-label">Statut par défaut</label>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="skip_duplicates">Ignorer les doublons (nom)</label>
                                        </div>
                                    </div>
                                    <div class="text-end">
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="small text-muted">
                                    ...
                                    <li>Vous pouvez remplir <strong>recipients_emails</strong> (séparés par virgule/ligne)</li>
                                    <li>Le statut sera <strong>draft</strong> par défaut</li>
                                </ul>
                            </div>
                        </div>
                    </div>
